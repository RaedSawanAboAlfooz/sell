...
@section('content')
    ...
    <div class="container" id="table">
        <div class="card"  style="padding-top:2%" >
              ...
              <form class="col" action="{{ route('category.create') }}">
              @csrf
              <button type="submit" id="add" class="btn btn-outline-dark" style="width: 12%">add Category</button>
              </form>
                ...
                <tr>
                    <td class="table-active">
                        <div class="row  ">
                            ...
                            <div class="col">
                                <form method="put" action="{{ route('category.edit',$item) }}">
                                    @csrf
                                    @method('PUT')
                            ...
                            <div class="col">
                                <form  action="{{ route('category.show',$item) }}">
                                    @csrf
                                    @method('GET')
